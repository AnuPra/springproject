...
public class WithdrawalCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        source.filter((key,value)-> value.contains("withdraw"));
        ...
        counts.toStream().to("withdrawal-output",Produced.with(Serdes.String(), Serdes.Long()));
